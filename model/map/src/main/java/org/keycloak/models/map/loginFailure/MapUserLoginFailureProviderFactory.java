...
import org.keycloak.models.LoginFailureProviderFactory;
 ...
 */
public class MapUserLoginFailureProviderFactory extends AbstractMapProviderFactory<LoginFailureProvider>
        implements LoginFailureProviderFactory {
    ...
    @Override
    public LoginFailureProvider create(KeycloakSession session) {
