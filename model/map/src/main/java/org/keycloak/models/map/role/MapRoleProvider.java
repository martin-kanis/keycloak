...
public class MapRoleProvider implements RoleProvider {
    ...
    public Stream<RoleModel> searchForRolesStream(RealmModel realm, String search, Integer first, Integer max) {
        ...
        ModelCriteriaBuilder<RoleModel> mcb = criteria();
        mcb = mcb.and(
                mcb.compare(SearchableFields.REALM_ID, Operator.EQ, realm.getId()),
                mcb.or(
    ...
    public Stream<RoleModel> searchForClientRolesStream(ClientModel client, String search, Integer first, Integer max) {
        ...
        ModelCriteriaBuilder<RoleModel> mcb = criteria();
        mcb = mcb.and(
                mcb.compare(SearchableFields.REALM_ID, Operator.EQ, client.getRealm().getId()),
                mcb.compare(SearchableFields.CLIENT_ID, Operator.EQ, client.getId()),
                mcb.or(
                        mcb.compare(SearchableFields.NAME, Operator.ILIKE, "%" + search + "%"),
                        mcb.compare(SearchableFields.DESCRIPTION, Operator.ILIKE, "%" + search + "%")
                )
