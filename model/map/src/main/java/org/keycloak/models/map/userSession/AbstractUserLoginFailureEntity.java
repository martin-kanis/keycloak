...
public abstract class AbstractUserLoginFailureEntity<K> implements AbstractEntity<K> {
    ...
    public void setFailedLoginNotBefore(int failedLoginNotBefore) {
        this.updated |= !Objects.equals(this.failedLoginNotBefore, failedLoginNotBefore);
    ...
    public void setNumFailures(int numFailures) {
        this.updated |= !Objects.equals(this.numFailures, numFailures);
    ...
    public void setLastFailure(long lastFailure) {
        this.updated |= !Objects.equals(this.lastFailure, lastFailure);
    ...
    public void clearFailures() {
        this.updated |= !Objects.equals(this.failedLoginNotBefore, 0) | !Objects.equals(this.numFailures, 0) |
                !Objects.equals(this.lastFailure, 0) | !Objects.equals(this.lastIPFailure, null);
