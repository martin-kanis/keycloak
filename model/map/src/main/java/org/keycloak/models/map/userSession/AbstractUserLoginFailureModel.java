...
public abstract class AbstractUserLoginFailureModel <E extends AbstractEntity> implements UserLoginFailureModel {
    ...
    public boolean equals(Object o) {
        ...
        if (realm.getId() != null ? !realm.getId().equals(that.realm) : that.realm != null) return false;
    ...
    @Override
    public int hashCode() {
        int hashCode = realm.getId() != null ? realm.getId().hashCode() : 0;
        hashCode = hashCode * 13 + (getUserId() != null ? getUserId().hashCode() : 0);
        return hashCode;
    }
}
